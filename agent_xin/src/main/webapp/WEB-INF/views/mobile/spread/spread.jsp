		...
		<div class="mt-20 clearfix" >
	       ...
	       <div class="person clearfix">
                   <ul class="floatL">
                     ...
                     <li>总绑定数 ：<span>${agentInfo.userNum1}</span></li>
                   </ul>
                   <ul class="floatL">
                     <li>今日充值 ：<span>${countTodayTotalFee/100}元</span></li>
                     <li>本月充值 ：<span>${countMothTotalFee/100}元</span></li>
                     <li>总充值 ：<span>${countAllTotalFee/100}元</span></li>
                   </ul>
		       </div>
