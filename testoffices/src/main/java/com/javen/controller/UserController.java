...
public class UserController {  
 ...
 // /user/{id}
    ...
    public @ResponseBody List<User> getUserInJson(@PathVariable String id,Map<String, Object> model){  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        List<User> user = this.userService.getList();  
        return user;  
    }  
    ...
    public String showUploadPage(){
    	System.out.println("niamniammin");
    ...
    public String doBottle(HttpServletRequest req , HttpServletResponse res){
