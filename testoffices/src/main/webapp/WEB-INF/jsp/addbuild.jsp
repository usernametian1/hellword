...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>办公楼名：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="inp ut-text" value="" placeholder="" id="buildname" name="buildname">
			</div>
		</div>
		
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">办公楼位置图片：</label>
				<div class="formControls col-xs-8 col-sm-9">
...
<script type="text/javascript">
	...
	$("#form-member-add").validate({
		...
		submitHandler:function(form){
			 $(form).ajaxSubmit({
					type : 'post',
					url : "<c:url value='/office/buildInsert'></c:url>",
					dataType : 'json',
					async: false, 
